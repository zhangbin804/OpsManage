...
class PagerHelper:
    ...
    def pager_str(self):
        ...
        if self.current_page == 1:
            ...
            pager_list.append('<li><a href="%s?p=%s">上一页</a></li>' % (self.base_url, self.current_page - 1,))
        ...
        for i in range(pager_range_start, pager_range_end+1):
            if i == self.current_page:
                pager_list.append('<li class="active"><a class="active" href="%s?p=%s" >%s</a></li>' % (self.base_url, i, i,))
            else:
        ...
        if self.current_page == v:
            ...
            pager_list.append('<li><a href="%s?p=%s">下一页</a></li>' % (self.base_url, self.current_page + 1,))
